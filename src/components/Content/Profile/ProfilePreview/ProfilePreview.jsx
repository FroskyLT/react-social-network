...
class ProfilePreview extends React.Component {
  render() {
    ...
    const isFollowInProgress = this.props.followInProgress.some(
      (userId) => userId === profileId
    );
    const currUserProfile = this.props.currUserId === profileId;
    const isFollowed = this.props.isFollowingUser;

    if (this.props.currUserId && !currUserProfile)
      this.props.isFollowing(profileId);
    ...
    return (
      <div className={styles.profilePreview}>
        ...
        <div className={styles.about}>
          <img
            src={
              this.props.profileData.photos.large ||
